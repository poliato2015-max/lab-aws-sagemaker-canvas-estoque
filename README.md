...
-  Faça o upload do dataset criado pela Inteligência Artificial Generativa na ferramenta SageMaker Canvas.
 ...
 - Configure as variáveis de entrada e saída de acordo com os dados. Escolha o nome e o tipo do modelo a ser criado. Neste projeto o próprio Sage Maker Canvas sugerio o modelo de análise preditiva.
